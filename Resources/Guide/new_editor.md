...
1、提交 pr 有一个粗审，由具有合入权限的人员处理。目前@皮拉夫大王在此，@师大小海腾 同样具有合入权限。
...
> 1、目前有些模块是有多人负责的，以模块为单位，如果在截稿日当天无内容推送，或者内容较少，不够原定内容的量，需要模块负责人在群内进行说明原因：是延期（最晚可延期至周六中午12点），还是本期无内容（无内容和内容较少都可请求群内小伙伴的帮助）。
>
