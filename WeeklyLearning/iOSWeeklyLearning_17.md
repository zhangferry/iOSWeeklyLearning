...
本期关键词：习惯、length 与 count 区别、TCP 握手、网络优化、Swift Algorithm Club、Paste

### 本期概要

这一期的`本期话题`从一个同学的问题入手，谈了些关于习惯的一些理解。

String.count 和 NSString.length 结果是一样的吗？他们直接有什么差别？后面的阅读可以帮你回答这个问题。

面试专题网络部分的第二弹，关于 TCP 连接，关于三次握手，四次握手。
...
虽然来自大脑的本能我们无法克服，但我们可以换个角度考虑这个问题，不再是考虑如何摆脱诱惑，而是如何培养一个定期学习的习惯。它们能达到一样的效果，而且相对来说，习惯养成比对抗本能还要更容易一些。

关于习惯有很多书专门去讲了，像是《习惯的力量》、《微习惯》等，这里不展开太多，仅说下我个人认为有用的几个小技巧：

* 拆分目标：把定时学习拆分成每天 5-10 分钟的固定学习，目标越小，我们在准备实施的时候遇到的阻力就会越小。比如我自己的学习微习惯，每天在群里分享一点自己学习的知识，平均准备时长在10分钟左右，偶有断开连接，但毕竟负担不大，多数时间都在坚持输出，已经差不多有一年时间了。**习惯行为的启动是最关键，最重要的，微习惯的核心目标就是为了解决这个启动的问题**。
* 找到监督环境：完全自觉是比较难的，可以施加一些外部监督力量。比如在公司的一天和在家的一天，同样的时间，大部分人的工作效果都是在公司更好一些，因为公司相当于外部的监督力量。还是我那个例子，我是用交流群充当监督作用，因为知道有人在期待这个，所以我要去做；类似的还有付费群，交钱入群，完成目标退钱，甚至还能挣钱；网络自习室，打开摄像头互相监督。
* 提供奖励：每完成一次目标都可以提供适当的奖励给自己，奖励的目的是让下次行动时能更容易一些，以此来形成一个闭环。对我那个分日分享的微习惯来说，奖励是间接的，因为这些总结的内容，是后期文章或者周报的素材，比如周报前期的编程概念模块都来源于此，所以对我来说奖励就是之后可以少一些工作。当然大家可以根据自己的情况设置适当的奖励，比如增加一点娱乐的时间等。
